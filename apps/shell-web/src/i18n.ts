...
const ZH: Record<string, string> = {
  ...
  'page.vault.title': '插件沙箱 (Plugin Vault Hub)',
  'page.vault.desc': 'NTFS Junction 零拷贝直连挂载 · 依赖伴随自愈 · 多版本原子快照回滚 · 静态安全审计',
...
const EN: Record<string, string> = {
  ...
  'page.vault.title': 'Plugin Vault Hub',
  'page.vault.desc': 'NTFS Junction Zero-Copy Mount · Companion Auto-Healing · Multi-Version Rollback · Security Audit',
