...
> 当前版本：**v0.6.2** ｜ Windows 10 / 11 ｜ 桌面（Tauri 2）+ Web
...
1. 从 [Releases](https://github.com/shengmk/godsh/releases) 下载 `godsh-0.6.2-x64-setup.exe`（安装版）或 `-x64.zip`（便携版）。
...
| [release/RELEASE_NOTES.md](release/RELEASE_NOTES.md) | 版本发布说明（v0.6.2 详述） |
